...
How Geoff Huntley approaches building and working with coding agents: his
firsthand account of the Ralph autonomous-loop technique he originated, its
failure modes, and its economics. One concept per file; this index lists them,
one line each.

- [Ralph autonomous loop technique](ralph-autonomous-loop-technique.md) — The monolithic orchestrator pattern Huntley originated: everything as a programmable loop, watching for failure domains, AFK development
- [Coding agent fundamentals](coding-agent-fundamentals.md) — The five essential tool primitives (read, list, bash, edit, search), model selection for agency, and the basic inferencing loop
