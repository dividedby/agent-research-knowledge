# Artifacts — maggieappleton

How Appleton's Ace multiplayer coding workspace is built, if and when her blog
documents harness or tooling internals firsthand. Material may land here (Ace
is an agent harness she is actively building) or in `practices/` — let the
